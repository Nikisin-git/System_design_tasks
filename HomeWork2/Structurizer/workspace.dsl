    ...
    model {
        ...
        companion_search = softwareSystem "Сервис поиска попутчиков" {
            ...
            auth_API_db = container "База данных аутентификации" {
                ...
                description "Хранит данные о логинах и паролях"
            }


            users_API_db = container "База данных пользователей" {
                tags "Database"
                technology "PostgreSQL Database"
            ...
            users_API = container "API пользователей" {
                ...
                -> users_API_db "Получение данных из запроса и помещение в базу" "SQL"
